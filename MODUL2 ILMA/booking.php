...
<div class="container-fluid">
  ...
  <div class="row" style="margin-top: 50px;">
    <div class="col-md-6 d-flex flex-row-reverse"  >
      <form style="width: 400px;" action="my_booking.php" method="post">            
        ...
        <div class="form-group">
          ...
          <?php  
            if (isset($_POST['btnStandard'])) {
              echo '<input class="form-control" type="text" value="Standard" name="room_type" readonly>';          
            } elseif (isset($_POST['btnSuperior'])) {
              echo '<input class="form-control" type="text" value="Superior" name="room_type" readonly>';
            } elseif (isset($_POST['btnLuxury'])) {
              echo '<input class="form-control" type="text" value="Luxury" name="room_type" readonly>';
            } else { ?>
              <select class="custom-select" name="room_type" required> 
        ...
        <div class="form-group">
          ...
          <div class="custom-control custom-checkbox" >                
            <input type="checkbox" class="custom-control-input" id="service" name="service[]" value="Room Service">
            <label class="custom-control-label" for="service">Room Service</label>              
          </div>            
          <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="breakfast" name="service[]" value="Breakfeast">
